...
function App() {
  ...
  const [updateCount, updateCountDispatch] = useReducer(
    (state) => state + 1,
    0
  );
    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center mt-2 gap-4 p-4 pb-20 max-w-xl mx-auto">
        ...
        <div className="form-control w-full">
          <label className="label">
            <span className="label-text">
              Noise Detail(波模様の大きさ) : {noiseDetail}
            </span>
          </label>
          <input
            disabled={stop}
        ...
        <div className="form-control w-full">
          <label className="label">
            <span className="label-text">
              NormalMap Strength(凹凸の強さ) : {normalMapStrength.toFixed(2)}
            </span>
          </label>
          <input
            disabled={stop}
        ...
        <div>
          <p>
            本サービスで生成された画像の権利は、生成したユーザに帰属します。
          </p>
          <p>
            つまり、作成・ダウンロードしたノーマルマップは、個人・商用問わず自由にご利用いただけます。改変や再配布も自由です。
          </p>
          <a
            className="text-blue-600"
            href="https://masabando.github.io/easy-three/"
          >
            easy-three
          </a>{" "}
          で使ってもらえると作者は喜びます。
